...
define(['knockout', './lib/models', './lib/dataManager'], function (ko, models, dataManager) {
    var Item = models.Item;
    
    var clickViewmodel = function(){
//        this.nicething = ko.observable('nice');
        this.nicething = new Item('banana',100);
        this.newItemName = '';
        this.items = [];
        ...
        this.addNewItem = function(){
            dataManager.addItem(this.newItemName);
            this.newItemName = '';
        }
        
        this.activate = function(){
            this.items = dataManager.geItems();
        }
